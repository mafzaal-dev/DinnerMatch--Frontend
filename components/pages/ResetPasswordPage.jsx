...
const inputBase =
  "w-full px-4 py-3 bg-[#111121] border rounded-lg text-[#F5F5F5] placeholder-[#424242] focus:outline-none focus:border-[#FFAA55] transition-colors pr-12 disabled:opacity-50";
...
const ResetPasswordPage = ({
  ...
  if (invalidLink) {
    return shell(
      <div className="bg-[#111121] border border-[#2F3A51] rounded-xl p-8 shadow-2xl">
        <h2 className="text-2xl font-bold text-[#F5F5F5] mb-2 text-center">
          Invalid reset link
        </h2>
        <p className="text-[#E0E0E0] text-center mb-8 text-sm">
  ...
  return shell(
    <div className="bg-[#111121] border border-[#2F3A51] rounded-xl p-8 shadow-2xl">
      <h2 className="text-2xl font-bold text-[#F5F5F5] mb-2 text-center">Set a new password</h2>
      <p className="text-[#E0E0E0] text-center mb-8">Choose a strong password for your account.</p>
      ...
      <form onSubmit={handleSubmit((data) => onSubmit?.(data))} className="space-y-6">
        <div>
          <label htmlFor="new_password" className="block text-sm font-semibold text-[#757575] mb-2">
            New password
          </label>
          <div className="relative">
            <input
              ...
              className={`${inputBase} ${errors.new_password ? "border-red-500" : "border-[#2F3A51]"}`}
            />
            <button
              type="button"
        ...
        <div>
          <label htmlFor="confirm_password" className="block text-sm font-semibold text-[#757575] mb-2">
            Confirm password
          </label>
          <div className="relative">
            <input
              ...
              disabled={isSubmitting}
              className={`${inputBase} ${errors.confirm_password ? "border-red-500" : "border-[#2F3A51]"}`}
            />
            <button
              type="button"
        ...
        <div className="flex justify-center">
          <button type="button" onClick={onSignIn} className="text-sm text-[#FFAA55] hover:underline transition-colors">
            Back to sign in
          </button>
        </div>
