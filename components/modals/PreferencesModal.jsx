                        ...
                        <div className="w-full space-y-8">
                            ...
                            <div className="space-y-4">
                                <button
                                    ...
                                    className="w-full bg-[#FFAA55] text-white py-3 px-4 rounded-lg font-bold uppercase tracking-widest hover:bg-[#FF9955] transition-all shadow-lg hover:shadow-[0_0_20px_rgba(255,170,85,0.4)] disabled:opacity-60 flex items-center justify-center gap-2"
